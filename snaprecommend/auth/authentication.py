...
from snaprecommend.auth.utils import post_macaroon, get_refreshed_discharge
...
def request_macaroon():
    ...
    """
    response = post_macaroon({"permissions": PERMISSIONS})
...
def get_refreshed_discharge(discharge):
    ...
    """
    response = get_refreshed_discharge({"discharge_macaroon": discharge})
